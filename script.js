...
function dashboard() {
  return `<h1>Welcome, ${user}.</h1>
      ...
      <ul>
      <li><a onClick="renderDocuments" id="docs">Documents</a></li>
      <li><a onClick="renderDocuments" id="vids">Video Logs</a></li>
      <li><a onClick="renderDocuments" id="voice">Voice Logs</a></li>
      </ul>
      </nav>
      <div id="console">
      </div>`;
